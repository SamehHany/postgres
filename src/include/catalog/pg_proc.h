...
DESCR("btree(internal)");
DATA(insert OID = 5100 (  hypcostestimate   PGNSP PGUID 12 1 0 0 0 f f f f t f v 7 0 2278 "2281 2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ hypcostestimate _null_ _null_ _null_ ));
DESCR("btree(internal)");
...
DATA(insert OID = 6015 (  hypbuild		   PGNSP PGUID 12 1 0 0 0 f f f f t f v 3 0 2281 "2281 2281 2281" _null_ _null_ _null_ _null_ _null_ hypbuild _null_ _null_ _null_ ));
DESCR("hyp(internal)");
